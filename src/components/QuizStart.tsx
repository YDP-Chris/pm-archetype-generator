  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-corporate-50 to-blue-50 flex items-center justify-center p-4">
      <div className="card max-w-2xl text-center">
        ...
        <div className="bg-corporate-50 rounded-lg p-6 mb-8">
          <h2 className="text-lg font-semibold text-corporate-800 mb-4">
        ...
        <div className="text-left bg-gray-50 rounded-lg p-6 mb-8">
          <h3 className="font-semibold text-gray-800 mb-3">What you'll discover:</h3>
